...
- (CGFloat)rowMargin
{
    if ([self.delegate respondsToSelector:@selector(rowMarginInWaterfallFlowLayout:)]) {
        return [self.delegate rowMarginInWaterfallFlowLayout:self];
    } else {
...
- (CGFloat)columnMargin
{
    if ([self.delegate respondsToSelector:@selector(columnMarginInWaterfallFlowLayout:)]) {
        return [self.delegate columnMarginInWaterfallFlowLayout:self];
    } else {
...
- (UICollectionViewLayoutAttributes *)layoutAttributesForItemAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    CGFloat h = [self.delegate waterfallFlowLayout:self heightForRowAtIndexPath:indexPath.item itemWidth:w];
